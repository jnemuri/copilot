...
class ModelOptions(
  ...
  def __new__(cls,
    ...
    """
    # Create a new instance of the ModelOptions class with the specified parameters.
    # The super() function is used to call the __new__ method of the superclass (namedtuple), 
    # which creates and returns a new object of that class.
